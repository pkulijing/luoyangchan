...
全国重点文物保护单位地图浏览工具。用户可在地图上探索 5000+ 文保单位，按省市县、类型筛选，查看详情。

数据库 schema 详见 [docs/SCHEMA.md](docs/SCHEMA.md)。
...
这是一个面向中国用户的项目，尽管我开发时的网络环境可以随意访问互联网，但最终上线后面向的用户是无法访问wikipdedia、google等网站的，所以设计开发时要考虑到这点，测试时可以用这些资源，上线前要确保不访问这些网站资源也能正常工作。
