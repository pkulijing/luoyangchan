...
| 批次 | 记录数 | 状态 | 处理模型 | 备注 |
|------|--------|------|---------|------|
| batch_001 | 100 | 完成 ✓ | Sonnet | |
| batch_002 | 100 | 完成 ✓ | Sonnet | |
| batch_003 | 100 | 完成 ✓ | Sonnet | |
| batch_004 | 100 | 完成 ✓ | Sonnet | tool_uses 撞上限，质量存疑 |
| batch_005 | 100 | 完成 ✓ | Sonnet | tool_uses 撞上限，质量存疑 |
| batch_006 | 100 | 完成 ✓ | Sonnet | |
| batch_007 | 100 | 完成 ✓ | Sonnet | |
| batch_008 | 100 | 完成 ✓ | Sonnet | tool_uses 撞上限，质量存疑 |
| batch_009 | 100 | 完成 ✓ | Sonnet | tool_uses 撞上限，质量存疑 |
| batch_010 | 100 | 完成 ✓ | Sonnet | 曾用 Haiku 跑过，已删除重跑 |
| batch_011 | 100 | 完成 ✓ | Sonnet | 曾用 Haiku 跑过，已删除重跑 |
| batch_012 | 100 | **损坏 ✗** | Sonnet | 59 条幻觉记录，58 条缺失，需重跑 |
| batch_013 | 100 | 待处理 | - | |
| batch_014 | 100 | 待处理 | - | |
| batch_015 | 100 | 待处理 | - | |
| batch_016 | 100 | 待处理 | - | |
...
**已完成可信批次：batch_001–011，共 1100 条**

完整性验证（release_id 一一对应，无缺失、无重复）：001-011 全部通过。
